...
# Function to create or load vector embeddings
            ...
            if filename.endswith(".pdf"):
                ...
                with pdfplumber.open(pdf_path) as pdf:
                    for page in pdf.pages:
                        ...
                        if text:
                            documents.append(SimpleDocument(text, metadata={"source": filename}))
...
if user_prompt:
  ...
  # Clear the input box after generating the response
